...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function displayRankings() {
        ...
        rankings.forEach((player, index) => {
            ...
            if (rankNumber <= 4) {
                rankItem.innerHTML = `<span class="text-6xl tracking-widest">${rankEmojis[rankNumber - 1]} -=></span><span class="tracking-widest">${displayName.toUpperCase()}</span>`;
            } else {
                rankItem.innerHTML = `<span class="text-6xl tracking-widest">${rankNumber}th -=></span><span class="tracking-widest">${displayName.toUpperCase()}</span>`;
            }
    ...
    function startTimerAnimation() {
        ...
        function updateTimer(currentTime) {
            ...
            if (percentage <= 20)
                timerIndicator.style.backgroundColor = "#ff4444";
            else if (percentage <= 50)
                timerIndicator.style.backgroundColor = "#ffaa44";
    ...
    function addHandStyles() {
        ...
        style.textContent = `
            ...
            #bot_player_hand_cards img { cursor: pointer !important; }
        `;
